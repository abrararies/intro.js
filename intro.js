  ...
  function _introForElement(targetElm) {
    ...
    if (this._options.steps) {
      ...
      for (var i = 0, stepsLength = this._options.steps.length; i < stepsLength; i++) {
        ...
        if (typeof(currentItem.parentScrollElement) === 'string') {
          //grab the element with given selector from the page
          currentItem.parentScrollElement = document.querySelector(currentItem.parentScrollElement);
        }
  ...
  */
  ...
  function _showElement(targetElement) {
    ...
    if (!_elementInViewport(targetElement.element) && this._options.scrollToElement === true) {
      ...
      if(targetElement.parentScrollElement && (typeof(targetElement.parentScrollElement) !== 'string')){
        if (top < 0 || targetElement.element.clientHeight > winHeight) {
          targetElement.parentScrollElement.scrollBy(0, top - this._options.scrollPadding); // 30px padding from edge to look nice
          //Scroll down
        } else {
          targetElement.parentScrollElement.scrollBy(0, bottom + 70 + this._options.scrollPadding); // 70px + 30px padding from edge to look nice
        }
      }else{
